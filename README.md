...
[![Version](https://img.shields.io/badge/version-0.2.0-blue.svg)](https://github.com/chvvkrishnakumar/expo-nativewind-template/releases)
[![Expo](https://img.shields.io/badge/Expo-SDK_54-000.svg?style=flat&logo=expo)](https://expo.dev)
[![React Native](https://img.shields.io/badge/React%20Native-0.81.6-61DAFB.svg?style=flat&logo=react)](https://reactnative.dev)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.9.2-blue.svg?style=flat&logo=typescript)](https://www.typescriptlang.org)
...
- **Push Notifications** - Requires development build (SDK 54+)
...
|---------|---------|-------------|--------------|
| [Expo SDK](https://expo.dev) | ~54.0.33 | React Native framework | [Docs](https://docs.expo.dev/) |
| [React Native](https://reactnative.dev) | 0.81.6 | Mobile framework | [Docs](https://reactnative.dev/docs/getting-started) |
| [TypeScript](https://www.typescriptlang.org) | ~5.9.2 | Type safety | [Docs](https://www.typescriptlang.org/docs/) |
| [Expo Router](https://expo.github.io/router) | ~6.0.23 | File-based routing | [Docs](https://docs.expo.dev/router/introduction/) |
| [NativeWind](https://www.nativewind.dev) | ^4.2.3 | Tailwind for RN | [Docs](https://www.nativewind.dev/v4/overview) |
